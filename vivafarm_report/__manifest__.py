{
    ...
    'data': [
        ...
        'data/viva_email_template_manual_upload.xml',
        ...
        'views/sale_order_portal_viva_manual_upload.xml',
        'views/sale_order_portal_viva_manual_upload_delivery.xml',
        'views/account_portal_viva_manual_upload_invoice.xml',
