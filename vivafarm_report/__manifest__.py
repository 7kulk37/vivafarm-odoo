{
    ...
    'data': [
        ...
        'views/wht_reminder_views.xml',
        'views/report_wht_attach.xml',
        'views/report_pnd_cover.xml',
        'views/report_pnd_official.xml',
        'views/pnd_return_views.xml',
