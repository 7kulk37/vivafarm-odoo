...
#: ~26.2pt, so 6 rows fit (signature block ends y=742pt vs 751pt usable) and
#: 7 rows overflow. Only product lines count — sections/notes share a row.
MULTIPAGE_PRODUCT_LINES = 7
